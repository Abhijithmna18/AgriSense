...
const ProfileSettings = () => {
    ...
    const handleSavePhoto = async () => {
        ...
        try {
            ...
            // await authAPI.updateProfile(payload); // Mock
        ...
        try {
            const payload = {
                ...
                addresses: [{
                    ...
                    label: 'home', country: 'India' // Defaults
                }]
            };
            ...
            // Correct API Call using new authApi method
            const response = await authAPI.updateProfile(payload);

            // Context update is usually handled by auth provider re-fetching or accepting new user object
            if (response.data) setUser(prev => ({ ...prev, ...response.data }));
    ...
    return (
        <div className="min-h-screen flex bg-[var(--admin-bg-primary)]">
